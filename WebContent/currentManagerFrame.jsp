	...
	<table title="currentEmpProfile">
		<tr>
			...
			<td><img title="profilePicture" height="150" width="150"
				src="PhotoServlet?photoName=${param.photoName}&username=${param.username}"
		...
		<tr>
			<th>CV:</th>
			<td><a
				href="CVServlet?CVName=${param.CVName}&username=${param.username}"><img
		...
		<tr>
			<th>ΑΜΚΑ:</th>
			<td><c:out value="${param.amka}" /></td>
		</tr>
		<tr>
			<th>ΑΦΜ:</th>
			<td><c:out value="${param.afm}" /></td>
		</tr>
		<tr>
			<th>Επώνυμο:</th>
		...
		<tr>
			<th>Φύλο:</th>
			<td><c:out value="${param.sexM}" /></td>
		</tr>
		<tr>
			<th>Ημερομηνία Πρόσληψης:</th>
			<td><c:out value="${param.date_of_RecruitmentM}" /></td>
		</tr>
	</table>
</body>
</html>