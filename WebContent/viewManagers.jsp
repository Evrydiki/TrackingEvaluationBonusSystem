...
<body>
				...
				<form action="DeleteEmployeeManagerServlet" method="POST"
					...
					<tr>
						<td><input type="hidden" value="${activeManager.am_ika}"
							name="am_ika"><c:out value="${activeManager.lastname}" /></td>
						...
						<td style="font-size: small; word-wrap: break-word;"><c:url
								...
								<c:param name="attribute" value="${activeManager.attribute}" />
							</c:url> <!-- view --> <a href="${managerUrl}" target="iframe_c">view</a></td>
					</tr>
				</form>
			</c:forEach>
		</table>
	...
	<div id="main" style="position: relative; left: 280px; width: 1000px;">
		<iframe id="emp" width="100%" height="800px" src="" name="iframe_c">
		</iframe>
	</div>
</body>
</html>